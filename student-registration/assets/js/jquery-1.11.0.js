...
!function (a, b) {
    ...
    n.fn = n.prototype = {
        ...
        expando: "jQuery" + (m + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (a) {
            ...
            return null == a ? a + "" : "object" == typeof a || "fun" == typeof a ? h[i.call(a)] || "object" : typeof a
    ...
    function s(a) {
        ...
        return "fun" === c || n.isWindow(a) ? !1 : 1 === a.nodeType && b ? !0 : "array" === c || 0 === b || "number" == typeof b && b > 0 && b - 1 in a
    }
                ...
                if (h) {
                    ...
                    !function f(b) {
                        n.each(b, function (b, c) {
                            var d = n.type(c);
                            "fun" === d ? a.unique && k.has(c) || h.push(c) : c && c.length && "string" !== d && f(c)
                        })
    ...
    function R(a, b, d, e) {
        if (n.acceptData(a)) {
            ...
            if (k && j[k] && (e || j[k].data) || void 0 !== d || "string" != typeof b)return k || (k = i ? a[h] = c.pop() || n.guid++ : h), j[k] || (j[k] = i ? {} : {toJSON: n.noop}), ("object" == typeof b || "fun" == typeof b) && (e ? j[k] = n.extend(j[k], b) : j[k].data = n.extend(j[k].data, b)), g = j[k], e || (g.data || (g.data = {}), g = g.data), void 0 !== d && (g[n.camelCase(b)] = d), "string" == typeof b ? (f = g[b], null == f && (f = g[n.camelCase(b)])) : f = g, f
        }
    }
    ...
    n.event = {
        ...
        on: function (a, b, c, d, e) {
            ...
            return (b === !1 || "fun" == typeof b) && (c = b, b = void 0), c === !1 && (c = cb), this.each(function () {
    ...
    n.offset = {
        ...
        return this.length
    }, n.fn.andSelf = n.fn.addBack, "fun" == typeof define && define.amd && define("jquery", [], function () {
        return n
    });
