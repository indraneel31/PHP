...
?>
<div class="main">
<h1 align="center"><font face="Hobo Std" color="#FF9900">Viewing the Fee Amount</font></h1>
<hr color="#999999">
...
<tr>
    ...
    <td><textarea style="40px" name="g_reason" id="5" placeholder="Reason" title="Reason" tabindex="6" required size="30"><?php echo $feedetails['s_reason']; ?></textarea></td>
</tr>
<tr>
...
<tr>
    ...
    <td><select name="g_status" id="7" title="Status" tabindex="9" required/>
        ...
        <option <?php if($feedetails['g_status'] == 'Single BedRoom'){?> selected="selected" <?php   }?> value="paid">Single BedRoomr</option>
		<option <?php if($feedetails['g_status'] == 'Double BedRoom'){?> selected="selected" <?php   }?> value="Half paid">Double BedRoom</option>
		<option <?php if($feedetails['g_status'] == 'Party Hall'){?> selected="selected" <?php   }?> value="not paid">Party Hall</option>
		</select></td>
</tr>
<tr>
<th></th>
