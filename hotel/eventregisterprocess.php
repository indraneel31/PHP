...
<ul id="menu">
    ...
    <ul class="hidden">
    <li><a href="displayfee.php">Fine For the Guest</a></li>
...
$arr['eventname'] 		 =	$_POST['eventname'];
$arr['date'] 			 =	$_POST['date1'];
$arr['month'] 			 =	$_POST['month1'];
$arr['year']			 =	$_POST['year1'];
$arr['eventorganiser']	 =	$_POST['eventorganiser'];
$arr['hour']			 =	$_POST['time1'];
$arr['min']				 =	$_POST['min1'];
$arr['tim']			 	 = 	$_POST['tim2'];
$arr['eventvenue']		 =	$_POST['eventvenue'];
$arr['eventdescription'] = 	$_POST['eventdescription'];
$id = '';

	$eve = new eventqueryprocess;
	$arr = $eve->add_event($arr);
?>
</div>
<?php }
else
