...
<form action="feeadded.php" method="POST" name="frmfeesave">
<tr>
	<th align="left">*Guest Name</th>
		<td><input type="text" name="g_name" id="1"  placeholder="Guest Name" title="Name" maxlength="20" tabindex="1" autofocus required  size="30"/></td>
</tr>
<tr>
	<th align="left">*Gender</th>
    <td><input type="radio" name="g_gender"  id="2" value="Male" title="Male" tabindex="2" required />Male
    <input type="radio" name="g_gender"  id="2" value="Female" title="Female" tabindex="3" required >Female</td>
</tr>
<tr>
	<th align="left">*Date & Time of Amount Entered</th>
	<td>	<input type="text" value="" id="datepicker" name="g_datetim" placeholder="Date of fee Entered" title="fee entered Date" tabindex="4" required size="30"/></td>

<tr>
	<th align="left">*Amount</th>
    <td><input type="text" name="g_fee" id="4" placeholder="fee Amount" title="fee Amount" maxlength="20" tabindex="5" required size="30"></td>
</tr>
<tr>
	<th align="left">*Reason</th>
    <td><textarea style="40px" name="g_reason" id="5" placeholder="Reason" title="Reason" tabindex="6" required size="30"></textarea></td>
</tr>
<tr>
	<th align="left">*Start Date</th>
    <td><input type="date" name="g_startdate" id="6" placeholder="Start Date" title="Start Date" maxlength="10" tabindex="7" required size="30"></td>
</tr>
<tr>
	<th align="left">*Last Date</th>
    <td><input type="date" name="g_lastdate" id="6" placeholder="Last Date" title="Last Date" maxlength="10" tabindex="8" required size="30"></td>
</tr>

<tr>
	<th align="left">*Room</th>
    <td><select name="g_status" id="7" title="Status" tabindex="9" required/>
		<option required>---Select Room---</option>
        <option required>Single BedRoom</option>
		<option required>Double Bed Room</option>
		<option required>Party Hall</option>
		</select></td>
</tr>
<tr>
<th></th>
